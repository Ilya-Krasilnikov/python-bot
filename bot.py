...
test_questions_spo = [
    {
        "text": "Какая деятельность привлекает вас больше всего?",
        "options": [
    ...
    {
        "text": "В работе с техникой и технологиями вы...",
        "options": [
            "🧑‍💻 Легко осваиваю новое ПО",
            "📊 Предпочитаю анализировать данные",
            "🔧 Люблю настраивать оборудование",
            "🤝 Общаюсь с клиентами"
        ],
        "points": [[2,0,0,0],[0,2,0,0],[0,0,2,0],[0,0,0,2]]
    },
    {
        "text": "Какую задачу вы решите лучше всего?",
        "options": [
            "🖥️ Написать код программы",
    ...
    {
        "text": "Ваше идеальное рабочее место — это...",
        "options": [
            "🧑‍💻 Офис IT-компании",
            "🏦 Офис банка",
            "🍽️ Ресторанная кухня",
    ...
    {
        "text": "Какую сферу для бизнеса вы бы выбрали?",
        "options": [
...
test_questions_bachelor = [
    {
        "text": "Какое направление вам кажется наиболее перспективным?",
        "options": [
    ...
    {
        "text": "В какой роли вы видите себя в будущем?",
        "options": [
    ...
    {
        "text": "Какая задача для вас наиболее интересна?",
        "options": [
            "🔧 Решение технической проблемы",
            "🗣️ Стратегическое планирование",
            "📉 Финансовое моделирование",
            "💡 Креативная разработка продукта"
        ],
        "points": [[2,0,0,0],[0,2,0,0],[0,0,2,0],[0,0,0,2]]
    },
    {
        ...
        "options": [
            "🧑‍💻 Дружная команда IT-специалистов",
            "👔 Иерархия и карьерный рост",
    ...
    if step < len(questions):
        ...
        if level == "spo":
            ...
            if max_idx == 0:
                ...
                result = "✨ Рекомендуем: Торговое дело (СПО)."
        else:
            points = [0,0,0,0]
            for i, ans_idx in enumerate(answers):
            ...
            if max_idx == 0:
                ...
                result = "📊 Рекомендуем: Экономика (бакалавриат)."
            else:
                result = "🛒 Рекомендуем: Торговое дело или Товароведение (бакалавриат)."
...
for event in longpoll.listen():
    if event.type == VkBotEventType.MESSAGE_NEW and event.message.text:
        ...
        if msg == "📅 Дни открытых дверей":
            ...
            send_message(user_id, "Используйте кнопки меню для навигации.", get_main_keyboard())
